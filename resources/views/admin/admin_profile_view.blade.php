        ...
        <div class="row">
            ...
            <div class="box box-inverse bg-img"  data-overlay="2">
                ...
                <div class="box-body text-center pb-50">
                  <a href="#">
                    <img class="avatar avatar-xxl avatar-bordered" src="{{!empty($adminData->profile_photo_path)? url('upload/admin_images/'.$adminData->profile_photo_path) : url('upload/default.jpg')}}" alt="">
                  </a>
